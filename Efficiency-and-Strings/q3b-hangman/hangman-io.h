...
// Usage examples:
//  For strings that contain a format specifier, such as not_in_word:
//      printf(not_in_word, 'h');
// For strings without a format specifier, such as invalid_play_again_response:
